	                    ...
	                    <?php while (have_posts()) : the_post(); ?>
		                    ...
		                    <table cellspacing="0" cellpadding="0" border="0" align="left">
		                        ...
		                        <tbody>		       
				                    ...
				                    ?>
				                        <tr>
				                            <td style="width:15%;"><strong><?=$content['month']; ?></strong></td>
							...
							<?php if($previous_pdf_title) { ?>   
				                <div class="table-footer">
				                    <span class="pdf-link"><a href="<?=$previous_pdf_link;?>" target="_blank"><img src="/prod/wp-content/themes/immk/images/PDFlogo.png" alt="pdf" class="PDF_LogoLink"><?=$previous_pdf_title;?></a></span>
				                </div>
				            <? } ?>  	
	                    <?php endwhile; ?>              
                    <?php endif; ?>	                 
