               ...
               <article>
                    <section> 
                      ...
                      <?php if (have_posts()) : ?>
                        ...
                        <div id="content-body">  
                            <?php the_content(); ?>                                                     
                              <div style="float:left;width: 100%;padding-bottom:40px;padding-top:20px;">  
                                <a class="button" style="    margin-left: 10px;" href="<?php the_field('button_1_link'); ?>" target="_blank"><?php the_field('button_1_link_text'); ?></a> 
                              </div>                         
                          </div>
                        <?php endwhile; ?>  
                      <?php endif; ?>       
